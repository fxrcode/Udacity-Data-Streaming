...
class Station(Producer):
    ...
    def __init__(self, station_id, name, color, direction_a=None, direction_b=None):
        ...
        #
        #
        # topic_name = f"chicago-transit.{station_name}.arrivals"  # TODO: Come up with a better topic name
    ...
    def run(self, train, direction, prev_station_id, prev_direction):
        ...
        try:
            ...
            logger.error(f"failed to produce arrivals {self.station_id} {train.train_id}, excep: {e}")
            raise e
